...
import (
	...
	mer "github.com/subrahamanyam341/andes-scenario-1234/scenario/expression/reconstructor"
)
...
func TestBech32(t *testing.T) {
	...
	result, err := ei.InterpretString("bech32:moa109vw87y3tmmxps242wlg5vra8e2jvphq4m5y95fqxs4y7av7dqeqw252t9")
	require.Nil(t, err)
	...
	require.Equal(t, "bech32:moa109vw87y3tmmxps242wlg5vra8e2jvphq4m5y95fqxs4y7av7dqeqw252t9", er.Reconstruct(result, mer.AddressHint))
}
...
func TestSCBech32(t *testing.T) {
	...
	result, err := ei.InterpretString("bech32:moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqplllsxxctf0")
	require.Nil(t, err)
	...
	require.Equal(t, "bech32:moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqplllsxxctf0", er.Reconstruct(result, mer.AddressHint))
}
