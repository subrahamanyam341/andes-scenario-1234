...
import vmcommon "github.com/subrahamanyam341/andes-vm-common-123"
...
func EnableEpochsHandlerStubAllFlags() *EnableEpochsHandlerStub {
	return &EnableEpochsHandlerStub{
		...
		IsMultiDCTTransferFixOnCallBackFlagEnabledField:      true,
		...
		IsDCTTransferRoleFlagEnabledField:                    true,
